...
export default function EuropeCountriesApp() {
  ...
  const handleAddCountry = () => {
    ...
    if (!trimmed) return;
    if (countries.some((country) => country.toLowerCase() === trimmed.toLowerCase())) {
      setNewCountry('');
      return;
    }
    ...
    <SafeAreaView style={styles.page}>
      <KeyboardAvoidingView
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>{countries.length} countries in the list</Text>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={() => (
            <Text style={styles.emptyText}>No countries left. Add one to get started.</Text>
          )}
          renderItem={({ item }) => (
